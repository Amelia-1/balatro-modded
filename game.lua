...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        c_insanity =        {order = 23, discovered = false, cost = 3, consumeable = true, name = "Insanity", pos = {x=2,y=2}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, config = {mod_conv = "m_crazy", max_highlighted = 1}},
        ...
        m_crazy = {max = 500, order = 10, name = "Crazy Card", set = "Enhanced", pos = {x=2,y=4}, effect = "Crazy Card", label = "Crazy Card", config = {}},
        m_nothing = {max = 500, order = 10, name = "Nothing Card", set = "Enhanced", pos = {x=1,y=3}, effect = "Nothing Card", label = "Nothing Card", config = {}},
